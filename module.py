...
#This is for detecting whether there is any hand in the frame and if there it will take the positions of hand
...
#This is for giving the landmarks(lines) for the detected hand
